...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($conn,"update members set first_name='$first_name' ,last_name='$last_name' , phone_number='$phone_number' where id='$uid'");
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="#"><img src="assets/images/logo.jpg" class="img-circle" width="60"></a></p>
      ...
      <?php $ret=mysqli_query($conn,"SELECT * FROM members WHERE id='".$_GET['uid']."'");
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="" value="<?php echo $row['last_name'];?>" >
                              </div>
                          </div>
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="contact" value="<?php echo $row['phone_number'];?>" >
                              </div>
                          </div>
                            <div class="form-group">
